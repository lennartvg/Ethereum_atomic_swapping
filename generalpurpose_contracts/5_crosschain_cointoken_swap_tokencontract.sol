...
contract CrosschainCoinTokenSwap_TokenContract {
    ...
    function CrosschainCoinTokenSwap_TokenContract(address _clientA, address _clientB, address _token, bytes32 _hashed_secret) public {
        clientA = _clientA;
        clientB = _clientB;
        token = _token;
